...
⌈ input (pure t) x , false ⌉ = Ex t # λ x₁ → ⌈ x x₁ , false ⌉
⌈ input (pure t) x , true ⌉ = All t # λ x₁ → ⌈ x x₁ , true ⌉
...
⌈ output (pure t) x , false ⌉ = All t # λ x₁ → ⌈ x x₁ , true ⌉
⌈ output (pure t) x , true ⌉ = Ex t # λ x₁ → ⌈ x x₁ , false ⌉
⌈ pure τ , _ ⌉ = $ τ
